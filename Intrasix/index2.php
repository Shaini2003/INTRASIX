...
<script>
	document.addEventListener('DOMContentLoaded', function() {
		...
		if (!notificationLink || !notificationDropdown || !unreadCount) {
		...
		function loadNotifications() {
			...
			fetch('get_notifications.php', {
				...
				.then(html => {
					console.log('Notifications HTML:', html);
				...
				.catch(error => {
					...
					notificationDropdown.innerHTML = '<span>Error loading notifications</span>';
				});
		}
    ...
    // Verify elements exist
    if (!messagesLink || !messagesDropdown || !messagesCount) {
        console.error('Required messages elements not found');
        return;
    }
    ...
    function loadMessages() {
        ...
        .then(html => {
            console.log('Messages Response:', html);
    ...
    messagesLink.addEventListener('click', function(e) {
        ...
        console.log('Messages dropdown active:', messagesDropdown.classList.contains('active'));
    });
    ...
    document.addEventListener('click', function(e) {
        if (!messagesLink.contains(e.target) && !messagesDropdown.contains(e.target)) {
            ...
            console.log('Messages dropdown hidden (clicked outside)');
        }
    });
});
</script>
			...
			<div class="top-area">
				...
				<ul class="setting-area">
					...
					<li class="notification-area">
						<a href="#" title="Notification" data-ripple="" id="notificationLink">
							<i class="ti-bell"></i>
							<span id="unreadCount">0</span>
						</a>
						<div class="dropdowns" id="notificationDropdown">
							<!-- Notifications will be loaded here -->
						</div>
					</li>

					<!-- Other menu items like Home and Notifications -->
					<li class="messages-area">
